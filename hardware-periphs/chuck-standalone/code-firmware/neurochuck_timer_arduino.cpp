...
// Timer routines - Mega 328p - Arduino IDE compatibility implementation.
...
// NOTE - This is the m328p version.
// Timers 0 and 2 are 8-bit, and Timer 1 is 16-bit.
// We're using Timer 1.
...
void Arduino_InitTimer(void)
{
  ...
  // Arduino always uses 0, and sometimes uses 1 and 2, depending on what
  // libraries are loaded.

  // FIXME - Leave timer 0 active; the wire library seems to need it.
